      ...
      <div className="prose prose-lg max-w-none">
        ...
        <section className="mb-8">
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><strong>User Account Data:</strong> Only your Google account email is stored for authentication</li>
        ...
        <section className="mb-8">
          ...
          <p className="mt-2">
            <strong>Email:</strong> <a href="mailto:privacy@upschedule.com" className="text-blue-600 hover:underline">privacy@upschedule.com</a>
          </p>
        </section>
