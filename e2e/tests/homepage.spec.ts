...
test.describe('Homepage', () => {
  test('should load homepage successfully', async ({ page }) => {
    ...
    await expect(page.getByText(/Transform your University of Pretoria PDF schedule/)).toBeVisible();
  ...
  test('should have footer with correct information', async ({ page }) => {
    ...
    await expect(footer.getByText('UP Schedule Generator')).toBeVisible();
    await expect(footer.getByText('Convert your UP PDF schedule to calendar events')).toBeVisible();
